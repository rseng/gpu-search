...
include/eigen3/unsupported/Eigen/CXX11/src/Tensor/README.md:GPU using cuda.  Additional implementations may be added later.
include/eigen3/unsupported/Eigen/CXX11/src/Tensor/README.md:GpuDevice.
include/eigen3/unsupported/Eigen/CXX11/src/Tensor/README.md:#### Evaluating On GPU
include/eigen3/unsupported/Eigen/CXX11/src/Tensor/README.md:You need to create a GPU device but you also need to explicitly allocate the
include/eigen3/unsupported/Eigen/CXX11/src/Tensor/README.md:memory for tensors with cuda.
include/eigen3/unsupported/Eigen/CXX11/src/Tensor/README.md:*   On GPUs only floating point values are properly tested and optimized for.
include/eigen3/unsupported/Eigen/CXX11/src/Tensor/README.md:*   Complex and integer values are known to be broken on GPUs. If you try to use
